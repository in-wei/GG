...
namespace GlobalCommond.ViewModel.Lrt
{
    ...
    public class EachSellReport
    {
        ...
        private List<string> _Title { get; set; }
        ...
        public void SetColumnTitle(List<string> vs) => _Title = vs;
        
        public List<string> GetColumnTitle() => _Title;
